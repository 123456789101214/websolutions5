<?php
    ...
    $data = mysqli_query($con, "select * from register where username ='$uname' and password = '$pass'");
...
<body>
    <div id="container">
        <a href="login.html" class="login" style="float: right;">Sign Out</a>
        <a href="index.html"><img src="img/demo-logo.png" alt="" class="logo"></a>
        <div id="conn">
            <a href="index.html" class="login">Sign In</a>
